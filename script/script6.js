...
d3.selectAll('.y-axis').on('change', function () {
    var type = $("#y-axis_main option:selected").val();
    if (type == "heart_rate") {
        plot_yVar.set('current_yVar', ['hr']);
        draw(dataset);
    }
...
d3.selectAll('.color').on('change', function () {
    var type = $("#color_main option:selected").val();
    if (type == "heart_rate") {
        plotColorVar.set('current_plotColorVar', ['hr']);
        draw(dataset);
    }
...
d3.selectAll('.radius').on('change', function () {
    var type = $("#radius_main option:selected").val();
    if (type == "heart_rate") {
        plotRadiusVar.set('current_plotRadiusVar', ['hr']);
        draw(dataset);
    }
...
// ToDo  change buttons to multiselect for the brush
